...
from samples import white, black, sample0, sample1, sample2, sample3, sample4, sample5
...
if __name__ == "__main__":
    # Use sample0 so white (agent) moves first
    testgame_timeout(p_white=agent, p_black=opponent, board_sample=sample1)